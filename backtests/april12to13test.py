...
def main():
    info: TradingMarketStrategyInfo = {
        ...
        'strategies': [KernelBasedLogStrategy(3),BAHStrategy(3), ExpGradStrategy(3), BestStockStrategy(3)],
    ...
    path = data_dir / 'april12to13' / 'merged' / 'DG-JNJ-TWTR.csv'
    ...
    while market.can_advance():
        market.advance()
    # Save the return
    backtest_name = 'april12to13test'  # make sure to change this for every new backtest!
